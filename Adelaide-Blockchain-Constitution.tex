...
\begin{subs}
\subsubsection{Organising and facilitating events for members and students;}
...
\item[(ii)] it is passed at a meeting referred to in this paragraph by a majority of not less then three-quarters of such members of the Association as, being entitled to do so, vote in person or where proxies are allowed, by proxy, at that meeting.
\end{itemize}
\end{subs}
...
\subsubsection{Any individual that wishes to become a member must provide their name and their email address through any type of form created by the Association or through email to the President. 
\subsubsection{Eligible individuals who have applied for membership shall become General Members once the Board approves such applications as they see fit.}
...
\begin{subs}
\subsection{A member may resign their membership at any time by notice in writing to the President of the Association.}
\end{subs}
...
\subsection{Particulars of the charge shall be communicated to the member at least 21 days before the meeting of the Board at which the matter will be determined.}
\subsection{The determination of the Board shall be communicated  to the member, and in the event of an adverse determination shall cease to be a member immediately the Board has communicated its determination to the member.}
\end{subs}
...
\begin{subs}
\subsection{At least 21 days notice of any general meeting shall be given to members. The notice shall set out where and when the meeting will be held, and particulars of the nature and order of the business to be transacted at the meeting.}
